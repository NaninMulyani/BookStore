...
namespace bookApi.Persistence.Postgres.Migrations
{
    ...
    [Migration("20240325064730_alterTBLBookColDesc")]
    partial class alterTBLBookColDesc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.Cart", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.FileRepository", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.Inventory", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.Option", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.RoleScope", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.UserDevice", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.UserToken", b =>
                {
            ...
            modelBuilder.Entity("bookApi.Domain.Entities.RoleScope", b =>
                {
                    b.HasOne("bookApi.Domain.Entities.Role", "Role")
                        .WithMany("RoleScopes")
