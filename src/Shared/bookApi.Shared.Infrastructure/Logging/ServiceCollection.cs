...
using bookApi.Shared.Infrastructure.Logging.Options;
...
using FileOptions = bookApi.Shared.Infrastructure.Logging.Options.FileOptions;

namespace bookApi.Shared.Infrastructure.Logging;
